...
export default function Chatbot({ user }: ChatbotProps) {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-4 left-4 h-[500px] max-h-[calc(100vh-8rem)] bg-white border border-slate-200/80 rounded-2xl flex flex-col overflow-hidden z-[9999] shadow-2xl animate-in slide-in-from-bottom-6 duration-300">
          {/* Header */}
          <div
